...
char str1[]="V.V.PURAM,BANGALORE-560004";
char str2[]="COMPUTER GRAPHICS & VISUALIZATION";
char str3[]="MINI PROFECT ON";
char str4[]="UNITY IS STRENGTH";
char str5[]="TEAM MEMBER :";
char str6[]="SUJIT NAYAK - 1BI16CS159";
char str7[]="SWARAJ A S - 1BI16CS163";
char str8[]="DEPT OF CSE,SEC C";
char str9[]="PROJECT GUIDED BY :";
char str10[]="Mrs GIRIJA J";
...
char str24[]="UNITED WE STAND DIVIDED WE FALL....";
glColor3f(0.498,1,0);
glRasterPos2f(20,50);
